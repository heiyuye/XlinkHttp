...
public class XLinkErrorCode {
     ...
     * 请求数据字段验证不通过
     */
    public static final int PARAM_VAILD_ERROR = 4001001;
    /**
     * 请求数据必须字段不可为空
     */
     ...
     * 验证码不存在
     */
    public static final int VERIFYCODE_NOT_EXISTS = 4001003;
    /**
     * 验证码错误
     */
    public static final int VERIFYCODE_ERROR = 4001004;
    /**
     * 注册的手机号已存在
     */
     ...
     * 密码错误
     */
    public static final int PASSWORD_ERROR = 4001007;
    /**
     * 帐号不合法
     */
     ...
     * 网络不可用
     */
    public static final int NETWORK_UNAVAILABLE = 502;
    ...
    public static ErrorWrapper.Error parseError(Response<?> response) {
        ...
        Retrofit.Builder retrofitBuilder = new Retrofit.Builder()
                ...
                .baseUrl(new XLinkHttpManager.Config().getBaseUrl())
                .addConverterFactory(GsonConverterFactory.create());
        retrofitBuilder.client(clientBuilder.build());

        Converter<ResponseBody, ErrorWrapper> converter = retrofitBuilder.build()
                .responseBodyConverter(ErrorWrapper.class, new Annotation[0]);
